...
@.const.picklebuf.140618475077952 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([102 x i8], [102 x i8]* @.const.pickledata.140618475077952, i32 0, i32 0), i32 102, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140618475077952.sha1, i32 0, i32 0) }
@.const.pickledata.140618475077952 = internal constant [102 x i8] c"\80\04\95[\00\00\00\00\00\00\00\8C\08builtins\94\8C\0CRuntimeError\94\93\94\8C6numba jitted function aborted due to unresolved symbol\94\85\94N\87\94."
@.const.pickledata.140618475077952.sha1 = internal constant [20 x i8] c"\97\BE\DC\DF\EC\8E\80\B7\09>P\CE%\EDV\F7r\0E\0C\9C"
...
@.const.picklebuf.140618466041664 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([77 x i8], [77 x i8]* @.const.pickledata.140618466041664, i32 0, i32 0), i32 77, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140618466041664.sha1, i32 0, i32 0) }
@.const.picklebuf.140618465989056 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([137 x i8], [137 x i8]* @.const.pickledata.140618465989056, i32 0, i32 0), i32 137, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140618465989056.sha1, i32 0, i32 0) }
@.const.picklebuf.140618464171264 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([86 x i8], [86 x i8]* @.const.pickledata.140618464171264, i32 0, i32 0), i32 86, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140618464171264.sha1, i32 0, i32 0) }
@.const.pickledata.140618464171264 = internal constant [86 x i8] c"\80\04\95K\00\00\00\00\00\00\00\8C\08builtins\94\8C\0BMemoryError\94\93\94\8C'Allocation failed (probably too large).\94\85\94N\87\94."
@.const.pickledata.140618464171264.sha1 = internal constant [20 x i8] c"\BA(\9D\81\F0\\p \F3G|\15sH\04\DFe\AB\E2\09"
@.const.pickledata.140618465989056 = internal constant [137 x i8] c"\80\04\95~\00\00\00\00\00\00\00\8C\08builtins\94\8C\0AValueError\94\93\94\8C[array is too big; `arr.size * arr.dtype.itemsize` is larger than the maximum possible size.\94\85\94N\87\94."
@.const.pickledata.140618465989056.sha1 = internal constant [20 x i8] c"X\E1N\CC\B5\07\B1\E0 i\81t\02#\E6\85\CB\8C<W"
@.const.pickledata.140618466041664 = internal constant [77 x i8] c"\80\04\95B\00\00\00\00\00\00\00\8C\08builtins\94\8C\0AValueError\94\93\94\8C\1Fnegative dimensions not allowed\94\85\94N\87\94."
@.const.pickledata.140618466041664.sha1 = internal constant [20 x i8] c"3\1B\85c\BD\B9\DA\C8\1B8B\22s\05,Ho\C1pk"
...
@.const.picklebuf.140618464299200 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([182 x i8], [182 x i8]* @.const.pickledata.140618464299200, i32 0, i32 0), i32 182, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140618464299200.sha1, i32 0, i32 0) }
@.const.picklebuf.140618465159232 = internal constant { i8*, i32, i8* } { i8* getelementptr inbounds ([69 x i8], [69 x i8]* @.const.pickledata.140618465159232, i32 0, i32 0), i32 69, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.const.pickledata.140618465159232.sha1, i32 0, i32 0) }
@.const.pickledata.140618465159232 = internal constant [69 x i8] c"\80\04\95:\00\00\00\00\00\00\00\8C\08builtins\94\8C\11ZeroDivisionError\94\93\94\8C\10division by zero\94\85\94N\87\94."
@.const.pickledata.140618465159232.sha1 = internal constant [20 x i8] c"\B2\80\08\A0\F8\8B\AD_\F0\F0$>\84\DA\B9\0C\AB\19\B3f"
@.const.pickledata.140618464299200 = internal constant [182 x i8] c"\80\04\95\AB\00\00\00\00\00\00\00\8C\08builtins\94\8C\0DOverflowError\94\93\94)\8C\09int_power\94\8Cw/home/runner/.cache/pypoetry/virtualenvs/numba-wasm-1lEsD5Wz-py3.9/lib/python3.9/site-packages/numba/cpython/numbers.py\94K\DE\87\94\87\94."
@.const.pickledata.140618464299200.sha1 = internal constant [20 x i8] c"Y`\CC\CD\E7\CCljHM\0B\0E\\\DB\04\E7hn+T"
...
.4:
  store { i8*, i32, i8* }* @.const.picklebuf.140618475077952, { i8*, i32, i8* }** %.2, align 8
...
B138.i:                                           ; preds = %entry, %B138.i
  ...
  %r.2.03.i = phi double [ %spec.select.i, %B138.i ], [ 1.000000e+00, %entry ]
  %a.1.2.02.i = phi double [ %.143.i, %B138.i ], [ %arg.input_value, %entry ]
  %.120.i = and i64 %exp.4.04.i, 1
  %.121.i = icmp ne i64 %.120.i, 0
  %.125.i = fmul double %r.2.03.i, %a.1.2.02.i
  %spec.select.i = select i1 %.121.i, double %.125.i, double %r.2.03.i
...
B0.endif.if:                                      ; preds = %entry
  store { i8*, i32, i8* }* @.const.picklebuf.140618466041664, { i8*, i32, i8* }** %excinfo, align 8
  ret i32 1, !ret_is_raise !1
...
B0.endif.endif.if:                                ; preds = %B0.endif.endif
  store { i8*, i32, i8* }* @.const.picklebuf.140618465989056, { i8*, i32, i8* }** %excinfo, align 8
  ret i32 1, !ret_is_raise !1
...
B0.if.i.i:                                        ; preds = %B0.endif.endif.endif
  store { i8*, i32, i8* }* @.const.picklebuf.140618464171264, { i8*, i32, i8* }** %excinfo.1.i, align 8, !alias.scope !18, !noalias !19
